name = "GPT4DST"
description = "Based on the langchain library calling OpenAI's GPT closed source model, providing an intelligent interactive experience for the Don't Starve Together (DST) game."
author = "gpt4dst developers"
version = "0.0.1"
